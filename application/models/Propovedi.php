...
//Application/Model/Propovedi.php
   class Propovedi extends CI_Model {
		...
		public function read_chten($id_prazdnik){
		    switch($id_prazdnik){
		        case 1: $fl=false; break;
		        case 52: $fl=false; break;
		        case 61: $fl=false; break;
		        case 69: $fl=false; break;
		        case 82: $fl=false; break;
		        case 88: $fl=false; break;
		        case 102: $fl=false; break;
		        case 114: $fl=false; break;
		        default: $fl=true;
		    }
if($fl){
        $this->load->database('default');
