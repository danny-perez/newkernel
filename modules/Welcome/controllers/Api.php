<?php 
   ...
   class Api extends CI_Controller {  
        ...
        '/api/ekzeget_all_link/имя таблицы из функции ekzeget_all/id записи в таблице/ выдает все толкования данного автора, если без аргументов, то список экзегетов с рассказом о них',
